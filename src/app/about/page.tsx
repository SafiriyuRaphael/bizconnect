...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="relative bg-white py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl md:text-3xl text-gray-600 max-w-5xl mx-auto mb-12 leading-relaxed font-medium">
            Connect, transact, and grow with the most powerful business platform
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { number: "10+", label: "Countries", icon: <Globe size={24} /> },
            ].map((stat, index) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                We're revolutionizing how businesses connect with customers by
                creating a seamless, transparent, and efficient digital
                marketplace that drives real growth.
              </p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">
                    10M+ in transactions facilitated
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-12 text-white transform rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-blue-200">
                  Started with a vision to simplify digital commerce
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto">
              Everything you need to succeed in the digital marketplace, all in
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-cyan-500 to-blue-500 rounded-3xl p-8 text-white hover:scale-105 hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-cyan-100 mb-6">
                Discover amazing businesses and enjoy seamless shopping
                experiences.
              </p>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-blue-50 py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
              ...
              <div key={index} className="relative">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div
                      className={`text-4xl font-black bg-gradient-to-r ${item.color} bg-clip-text text-transparent mb-2`}
                    >
                      {item.step}
                    </div>
                ...
                {index < 3 && (
                  <div className="w-0.5 h-8 bg-gradient-to-b from-gray-300 to-transparent ml-8 mt-4"></div>
                )}
              </div>
            ))}
          </div>
            ...
            <div className="space-y-24">
              {[
                ...
                >
                  <div
                    className={`w-1/2 ${
                      item.position === "right" ? "pl-16" : "pr-16"
                    }`}
                  >
                    <div
                      className={`bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 ${
                        item.position === "right" ? "text-right" : ""
                      }`}
                    >
                      <div
                        className={`text-8xl font-black bg-gradient-to-r ${item.color} bg-clip-text text-transparent mb-4`}
                      >
                        {item.step}
                      </div>
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${item.color} rounded-full border-4 border-white shadow-lg flex items-center justify-center hover:scale-125 transition-transform duration-300`}
                    >
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl text-gray-600 mb-12 leading-relaxed">
            Join thousands of successful businesses already growing with
            BizConnect. Your digital transformation starts here.
          </p>
