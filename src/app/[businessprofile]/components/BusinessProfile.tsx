...
const UsersProfile = ({
  ...
  const userReview = getUserReviews({ businessId: user._id, userId: reviewId });
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              {user.userType === "business" && user.businessDescription && (
                <div className="mt-4 pt-4 border-t">
                  <p className="text-gray-700">{user.businessDescription}</p>
                </div>
              )}
            </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-600">{user.deliveryTime} days</p>
                  </div>
                </div>
              </div>
            )}
