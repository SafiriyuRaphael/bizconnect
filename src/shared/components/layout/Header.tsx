...
import ProfileImage from "../composites/ProfileImage";
import getVerificationStatus from "@/lib/business/getVerificationStatus";
import { VerificationStatusProps } from "../../../../types";
import WalletModal from "../composites/WalletDropdown";
import NotificationDropdown from "../composites/NotificationDropdown";
            ...
            <Link href="/" className="flex items-center group cursor-pointer">
              <div className="relative">
                <Image
                  ...
                  src="/bizcon.svg"
                  alt=""
                  className="size-20 sm:size-12  group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 "
                />
              </div>
              <div className="ml-3">
