...
import { AnyUser, BusinessDisplayPicsProps, ProductItemsResponse, ProductsItem, ProductsItemsPageProps } from '../../../types';
...
interface ProductState {
    userItemsQuery: GetUserItemsQuery
    setUserItemsQuery: (userItems: GetUserItemsQuery) => void
    image: ImageProps[]
    userId: string
    quantity: number
    ...
    itemData: ProductsItemsPageProps | null
    setShowViewProduct: (show: boolean) => void;
    setItemData: (item: ProductsItemsPageProps) => void;
